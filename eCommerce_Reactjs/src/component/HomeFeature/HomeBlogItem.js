            ...
            <div className="single-blog">
                ...
                <div className="short_details">
                    <div className="meta-top d-flex">
                        <a href='/' >{props.data.userData.firstName + " " + props.data.userData.lastName}</a>
                        <a href='/' ><i className="ti-comments-smiley" />{props.data.commentData.length} Bình luận</a>
                    </div>
                    ...
                    <a href='/' className="blog_btn">Xem thêm<span className="ml-2 ti-arrow-right" /></a>
                </div>
            </div>
        </div>
    );

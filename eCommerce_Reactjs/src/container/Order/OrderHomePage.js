                                        ...
                                        <tbody>
                                            {dataCart && dataCart.length > 0 &&
                                                dataCart.map((item, index) => {
                                                    ...
                                                    return (
                                                        <ShopCartItem isOrder={true} id={item.id} userId={userId} productId={item.productData.id} productdetailsizeId={item.productdetailsizeData.id} key={index} name={name} price={item.productDetail.discountPrice} quantity={item.quantity} image={item.productDetailImage[0].image} />
                                                    )
                                                })
                                            }
                                        </tbody>
                                ...
                                <div>
                                    {typeShip && typeShip.length > 0 &&
                                        typeShip.map((item, index) => {
                                            return (
                                                <div key={index} className="form-check">
                                                    <input className="form-check-input" checked={item.id === dataTypeShip?.id ? true : false} type="radio" name="typeshipRadios" id={item.type} onChange={() => handleChooseTypeShip(item)} />
                                                    <label for={item.type} className="form-check-label">

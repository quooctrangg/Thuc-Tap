        ...
        <div className="col-md-3">
            <ul className="list-category">
                ...
                <li>
                    ...
                    <ul>
                        <li><i style={{ color: '#ee4d2d' }} className="fa-solid fa-caret-right"></i> <Link to={`/user/detail/${props.id}`}>Hồ sơ</Link></li>
                        <li><i style={{ color: '#ee4d2d' }} className="fa-solid fa-caret-right"></i> <Link to={`/user/address/${props.id}`}>Địa chỉ</Link></li>
                        <li><i style={{ color: '#ee4d2d' }} className="fa-solid fa-caret-right"></i> <Link to={`/user/changepassword/${props.id}`}>Đổi mật khẩu</Link></li>
                    </ul>
                </li>
